...
#############################################
#                                           #
#  demoD.R : demo with large  dataset       #
#                                           #
#############################################
...
################### eventually launch tests before large calculations
# tests_run()
...
t1 <- Sys.time()
prediction <- nestedKriging(X=X, Y=Y, clusters=clusters$cluster, x=x , covType=covType, param=param, sd2=sd2,
                             krigingType=krigingType, tagAlgo='demo D',
                             numThreads=16, verboseLevel=20, outputLevel=0)
