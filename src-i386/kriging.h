...
// struct enum replaces enum class which cannot be used as integer template argument without cast
...
public:
  ...
  virtual void fillResults(arma::vec& weights, double& mean_M, double& cov_MY, double& cov_MM)  const {
...
private:
  ...
  virtual void fillResultsHelper(arma::mat& weights, arma::rowvec& mean_M, std::vector<double>& cov_MY, std::vector<double>& cov_MM, const arma::mat& Kinv, const Precomputations& precomp) const {
  ...
  virtual void fillResultsHelper(arma::vec& weights, double& mean_M, double& cov_MY, double& cov_MM, const arma::mat& Kinv, const Precomputations& precomp)  const {
